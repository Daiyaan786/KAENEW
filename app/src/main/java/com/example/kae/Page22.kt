...
class Page22 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //
        val entryDescription = "Poetry"
        vanneNameEditText = findViewById(R.id.editTextText99)
        GraadEditText = findViewById(R.id.editTextText98)
        PoetryPOEditText = findViewById(R.id.editTextText97)
    ...
    private fun showToast(message: String) {
        Toast.makeText(this@Page22, message, Toast.LENGTH_SHORT).show()
    }
}