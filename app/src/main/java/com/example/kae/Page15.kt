...
class Page15 : AppCompatActivity() {
    ...
    private lateinit var KJEditText: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //
        val entryDescription = "Klavier Junior Samespel (Junior Piano Duet) Graad 6-7"
        vanneNameEditText = findViewById(R.id.editTextText70)
        skoolGraadEditText = findViewById(R.id.editTextText71)
        KJEditText = findViewById(R.id.editTextText72)
        FaceToFaceCheckBox = findViewById(R.id.checkBox29)
        VideoCheckBox = findViewById(R.id.checkBox30)
        ...
        button.setOnClickListener {
            ...
            val KJ = KJEditText.text.toString()
            //
            ...
            //FaceToFace is checked
                ...
                FaceToFace=true
                submitDataToFirebase(entryDescription,vanneEnName, skoolGraad, KJ, FaceToFace)
            }
            //Video is checked
    ...
    private fun submitDataToFirebase(description: String, vanneEnName: String, skoolGraad: String, KJ: String, FaceToFace: Boolean) {
    ...
    private fun showToast(message: String) {
        Toast.makeText(this@Page15, message, Toast.LENGTH_SHORT).show()
    }
}