...
class Page37 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //
        val entryDescription = "Dromstel(Percussion) Junior"
        vanneNameEditText = findViewById(R.id.editTextText186)
        SkoolGraadEditText = findViewById(R.id.editTextText182)
        DromstelJPEditText = findViewById(R.id.editTextText185)
        PerkussieJPEditText = findViewById(R.id.editTextText187)
        DuetOrTrioJPEditText = findViewById(R.id.editTextText181)
        FaceToFaceCheckBox = findViewById(R.id.checkBox64)
        VideoCheckBox = findViewById(R.id.checkBox63)
        val button: Button = findViewById(R.id.button32)
        //
        //SUBMIT BUTTON
    ...
    private fun showToast(message: String) {
        Toast.makeText(this@Page37, message, Toast.LENGTH_SHORT).show()
    }
}