...
class Page36 : AppCompatActivity() {
    ...
    private lateinit var STSEditText: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //
        val entryDescription = "Strykinstrumente (Strings) Senior Duet"
        vanneNameEditText = findViewById(R.id.editTextText184)
        STSEditText = findViewById(R.id.editTextText183)
        FaceToFaceCheckBox = findViewById(R.id.checkBox66)
        VideoCheckBox = findViewById(R.id.checkBox65)
        val button: Button = findViewById(R.id.button31)
        //
        //SUBMIT BUTTON
        button.setOnClickListener {
            //
            val vanneEnName = vanneNameEditText.text.toString()
            val STS = STSEditText.text.toString()
            //
            ...
            //FaceToFace is checked
                ...
                FaceToFace=true
                submitDataToFirebase(entryDescription,vanneEnName, STS, FaceToFace)
            }
            //Video is checked
    ...
    private fun submitDataToFirebase(description: String, vanneEnName: String, STS: String, FaceToFace: Boolean) {
    ...
    private fun showToast(message: String) {
        Toast.makeText(this@Page36, message, Toast.LENGTH_SHORT).show()
    }
}