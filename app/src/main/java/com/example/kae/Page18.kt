...
class Page18 : AppCompatActivity() {
    ...
    private lateinit var KBEditText: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //
        val entryDescription = "Koperblaasnstrumente (Brass Instruments) Duet"
        vanneNameEditText = findViewById(R.id.editTextText77)
        KBEditText = findViewById(R.id.editTextText78)
        FaceToFaceCheckBox = findViewById(R.id.checkBox33)
        VideoCheckBox = findViewById(R.id.checkBox34)
        ...
        button.setOnClickListener {
            ...
            val KB = KBEditText.text.toString()
            //
            ...
            //FaceToFace is checked
                ...
                FaceToFace=true
                submitDataToFirebase(entryDescription,vanneEnName, KB, FaceToFace)
            }
            //Video is checked
    ...
    private fun submitDataToFirebase(description: String, vanneEnName: String, KB: String, FaceToFace: Boolean) {
    ...
    private fun showToast(message: String) {
        Toast.makeText(this@Page18, message, Toast.LENGTH_SHORT).show()
    }
}